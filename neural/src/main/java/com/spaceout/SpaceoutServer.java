...
public class SpaceoutServer implements HttpHandler {
    ...
    private SpaceoutServer() throws IOException {
        System.out.println("Bears just want to have fun.");
    ...
    private final void handleExchange(String remoteHostAddress, String messageString, BufferedWriter responseWriter) {
        try {
            responseWriter.write("{\"bored\": " + EmotivWrapper.getBoredScore() + ", \"excite\": " + EmotivWrapper.getExciteScore() + ", \"frust\": " + EmotivWrapper.getFrustScore() + ", \"med\": " + EmotivWrapper.getMedScore() + "}");
    ...
    public static void main(String[] args) {
        try {
            ...
            System.err.println("Failed to startup HTTP server: exiting!" + ex);
            System.exit(1);
        }
